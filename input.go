// gofmt error: 277:8: expected ';', found current (and 3 more errors)
...
type AcceptBusinessMemberInvitationInput struct {
...
// CancelBusinessAdminInvitationInput is an autogenerated input type of CancelBusinessAdminInvitation.
type CancelBusinessAdminInvitationInput struct {
	// The Node ID of the pending business admin invitation. (Required.)
	InvitationID ID `json:"invitationId"`
...
// CancelBusinessBillingManagerInvitationInput is an autogenerated input type of CancelBusinessBillingManagerInvitation.
type CancelBusinessBillingManagerInvitationInput struct {
	// The Node ID of the pending business billing manager invitation. (Required.)
	InvitationID ID `json:"invitationId"`
...
// InviteBusinessAdminInput is an autogenerated input type of InviteBusinessAdmin.
type InviteBusinessAdminInput struct {
	// The ID of the business to which you want to invite an administrator. (Required.)
	BusinessID ID `json:"businessId"`
...
// InviteBusinessBillingManagerInput is an autogenerated input type of InviteBusinessBillingManager.
type InviteBusinessBillingManagerInput struct {
	// The ID of the business to which you want to invite a billing manager. (Required.)
	BusinessID ID `json:"businessId"`

	// The login of a user to invite as a billing manager. (Optional.)
	Invitee *String `json:"invitee,omitempty"`
	// The email of the person to invite as a billing manager. (Optional.)
	Email *String `json:"email,omitempty"`
	// A unique identifier for the client performing the mutation. (Optional.)
	ClientMutationID *String `json:"clientMutationId,omitempty"`
}
...
// RegenerateBusinessIdentityProviderRecoveryCodesInput is an autogenerated input type of RegenerateBusinessIdentityProviderRecoveryCodes.
type RegenerateBusinessIdentityProviderRecoveryCodesInput struct {
	// The ID of the business on which to set an Identity Provider. (Required.)
	BusinessID ID `json:"businessId"`
...
// RemoveBusinessAdminInput is an autogenerated input type of RemoveBusinessAdmin.
type RemoveBusinessAdminInput struct {
	// The Business ID to update. (Required.)
	BusinessID ID `json:"businessId"`
	// The login of the user to add as an admin. (Required.)
...
// RemoveBusinessBillingManagerInput is an autogenerated input type of RemoveBusinessBillingManager.
type RemoveBusinessBillingManagerInput struct {
	// The Business ID to update. (Required.)
	BusinessID ID `json:"businessId"`
	// The login of the user to add as a billing manager. (Required.)
	Login String `json:"login"`
...
// RemoveBusinessIdentityProviderInput is an autogenerated input type of RemoveBusinessIdentityProvider.
type RemoveBusinessIdentityProviderInput struct {
	// The ID of the business from which to remove the Identity Provider. (Required.)
	BusinessID ID `json:"businessId"`
...
// SetBusinessIdentityProviderInput is an autogenerated input type of SetBusinessIdentityProvider.
type SetBusinessIdentityProviderInput struct {
	// The ID of the business on which to set an Identity Provider. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessAllowPrivateRepositoryForkingSettingInput is an autogenerated input type of UpdateBusinessAllowPrivateRepositoryForkingSetting.
type UpdateBusinessAllowPrivateRepositoryForkingSettingInput struct {
	// The ID of the business on which to set the allow private repository forking setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessDefaultRepositoryPermissionSettingInput is an autogenerated input type of UpdateBusinessDefaultRepositoryPermissionSetting.
type UpdateBusinessDefaultRepositoryPermissionSettingInput struct {
	// The ID of the business on which to set the default repository permission setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessMembersCanChangeRepositoryVisibilitySettingInput is an autogenerated input type of UpdateBusinessMembersCanChangeRepositoryVisibilitySetting.
type UpdateBusinessMembersCanChangeRepositoryVisibilitySettingInput struct {
	// The ID of the business on which to set the members can change repository visibility setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessMembersCanCreateRepositoriesSettingInput is an autogenerated input type of UpdateBusinessMembersCanCreateRepositoriesSetting.
type UpdateBusinessMembersCanCreateRepositoriesSettingInput struct {
	// The ID of the business on which to set the members can create repositories setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessMembersCanDeleteIssuesSettingInput is an autogenerated input type of UpdateBusinessMembersCanDeleteIssuesSetting.
type UpdateBusinessMembersCanDeleteIssuesSettingInput struct {
	// The ID of the business on which to set the members can delete issues setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessMembersCanDeleteRepositoriesSettingInput is an autogenerated input type of UpdateBusinessMembersCanDeleteRepositoriesSetting.
type UpdateBusinessMembersCanDeleteRepositoriesSettingInput struct {
	// The ID of the business on which to set the members can delete repositories setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessMembersCanInviteCollaboratorsSettingInput is an autogenerated input type of UpdateBusinessMembersCanInviteCollaboratorsSetting.
type UpdateBusinessMembersCanInviteCollaboratorsSettingInput struct {
	// The ID of the business on which to set the members can invite collaborators setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessOrganizationProjectsSettingInput is an autogenerated input type of UpdateBusinessOrganizationProjectsSetting.
type UpdateBusinessOrganizationProjectsSettingInput struct {
	// The ID of the business on which to set the organization projects setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessProfileInput is an autogenerated input type of UpdateBusinessProfile.
type UpdateBusinessProfileInput struct {
	// The Business ID to update. (Required.)
	BusinessID ID `json:"businessId"`

	// The name of business. (Optional.)
	Name *String `json:"name,omitempty"`
	// The description of the business. (Optional.)
	Description *String `json:"description,omitempty"`
	// The URL of the business's website. (Optional.)
...
// UpdateBusinessRepositoryProjectsSettingInput is an autogenerated input type of UpdateBusinessRepositoryProjectsSetting.
type UpdateBusinessRepositoryProjectsSettingInput struct {
	// The ID of the business on which to set the repository projects setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessTeamDiscussionsSettingInput is an autogenerated input type of UpdateBusinessTeamDiscussionsSetting.
type UpdateBusinessTeamDiscussionsSettingInput struct {
	// The ID of the business on which to set the team discussions setting. (Required.)
	BusinessID ID `json:"businessId"`
...
// UpdateBusinessTwoFactorAuthenticationRequiredSettingInput is an autogenerated input type of UpdateBusinessTwoFactorAuthenticationRequiredSetting.
type UpdateBusinessTwoFactorAuthenticationRequiredSettingInput struct {
	// The ID of the business on which to set the two factor authentication required setting. (Required.)
	BusinessID ID `json:"businessId"`
